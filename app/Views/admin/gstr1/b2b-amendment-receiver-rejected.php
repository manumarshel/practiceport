        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5>Amended B2B Invoices</h5>
                    <div class="">
                        <a href="<?= base_url('admin/gstr1/b2b-amendment/rejected-add/'.$question_id) ?>" class="btn btn-primary btn-sm">
                            Add New
                        </a>
                ...
                <div class="m-t-30">
                   <?php echo view('admin/gstr1/b2b_amendment_navbar');?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($data_list as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-icon btn-primary btn-tone" href="<?= base_url() . '/admin/gstr1/b2b-amendment/rejected-add/' . $value->question_id . '/' . $v['9a_b2b_id']; ?>">
                                                    <i class="anticon anticon-edit"></i>
                                                </a>
                                                <button class="btn btn-icon btn-danger btn-tone common_remove" data-question_id="<?= $value->question_id; ?>" data-pk_id="<?= $v['9a_b2b_id']; ?>">
                        ...
                        <div class="modal fade" id="delete_item">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="<?= base_url() . '/admin/gstr1/b2b-amendment/rejected/remove' ?>" method="post">
