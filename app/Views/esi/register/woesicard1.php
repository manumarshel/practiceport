...
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><title>EmployeeRegistration</title><link rel="stylesheet" type="text/css" href="../../public/assets/esi/woesicard1/esicCSSglobal.css"><link rel="stylesheet" type="text/css" href="../../public/assets/esi/woesicard1/esiccsstaskhome.css"><link rel="stylesheet" type="text/css" href="../../public/assets/esi/woesicard1/esiclayout.css">




    <script type="text/javascript" src="../../public/assets/esi/woesicard1/JavaScript1.js"></script>
    ...
    <link href="../../public/assets/esi/woesicard1/WebResource.css" type="text/css" rel="stylesheet"><link type="text/css" rel="stylesheet" href="../../public/assets/esi/woesicard1/WebResource.css"></head>
...
<script src="../../public/assets/esi/woesicard1/WebResource_002.js" type="text/javascript"></script>


<script src="../../public/assets/esi/woesicard1/ScriptResource_005.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_003.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/jquery1.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/esic.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_008.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_002.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_013.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_007.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_005.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_006.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_004.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_010.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_003.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_011.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_009.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_012.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_002.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/ScriptResource_004.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard1/WebResource.js" type="text/javascript"></script>
<script type="text/javascript">
//<![CDATA[
...
//]]>
	...
	<tbody><tr>
		<td class="tHeadImage" align="left"><img id="ctl00_ESICLogo" src="../../public/assets/esi/woesicard1/Small%20Logo.jpg" align="absmiddle" style="border-width:0px;"></td><td class="tHeadImage" align="center"></td><td class="tHeadImage" align="right"><img id="ctl00_Image1" src="../../public/assets/esi/woesicard1/IndianSymbol.jpg" align="absmiddle" style="border-width:0px;"></td>
	</tr><tr>
...
if (confirm('You have not complied with the provisions of Regulation 10B read with Regulation 11 & 12 of the Employees’ State Insurance (General) Regulation, 1950, regarding registration of employee within 10 days of the Date of Appointment. Therefore, the Date of Appointment of this employee will be subject to confirmation by the concerned RO/SRO after due verification of relevant records. Until then, the date of registration shall be deemed as the date of appointment. Please submit the relevant records/documents to the designated RO/SRO within 15 days in the prescribed format. Please also take note that in case of failure to do the needful, the date of registration will be treated as the date of appointment, for all purposes.')) {
   return;
	...
	<tbody><tr>
		<td><input id="ctl00_HomePageContent_rbtnlistIsregistered_0" type="radio" name="ctl00$HomePageContent$rbtnlistIsregistered" value="0" onclick="javascript:setTimeout('__doPostBack(\'ctl00$HomePageContent$rbtnlistIsregistered$0\',\'\')', 0)"><label for="ctl00_HomePageContent_rbtnlistIsregistered_0">Yes</label></td><td><input id="ctl00_HomePageContent_rbtnlistIsregistered_1" type="radio" name="ctl00$HomePageContent$rbtnlistIsregistered" value="1" checked="checked"><label for="ctl00_HomePageContent_rbtnlistIsregistered_1">No</label></td>
	</tr>
</tbody></table>
                                    </td>
                                </tr>
                            </tbody></table>
                            <div id="ctl00_HomePageContent_Panel2">
                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="0" class="internalTable3">
                                    <tbody><tr>
                                        ...
                                        <td colspan="2" class="lastFormValue" width="60%">
                                            <input name="ctl00$HomePageContent$txtmobilenumber" type="text" value="<?php echo $mobile ?? ''; ?>" maxlength="10" id="ctl00_HomePageContent_txtmobilenumber" disabled="disabled" class="txtbox numericAlignRight" autocomplete="Off" onkeypress="return onlyNumbers(event)">
                                            <span id="ctl00_HomePageContent_RequiredFieldValidator3" style="color:Red;display:none;">Please enter mobile number</span>
                                            <span id="ctl00_HomePageContent_PresentMobileNoRegularExpressionValidator1" class="errordisplay" style="color:Red;display:none;">The mobile number doesn’t contain 10 digits. Please enter correct Mobile Number</span>
                                            <a onclick="startTimer();" id="ctl00_HomePageContent_lnkmobilecheck" href='javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions("ctl00$HomePageContent$lnkmobilecheck", "", true, "", "", false, true))'>Validate Mobile Number</a>
                                            <span id="ctl00_HomePageContent_lblerrormobile" style="color:Red;"></span>
                            ...
                            <div id="ctl00_HomePageContent_pnlFootnote">
	
                                <table width="100%" border="0" cellpadding="2" cellspacing="0" class="internalTable3">
                                    <tbody><tr>
                                        <td class="lastFormValue" colspan="4">
                                            <span id="ctl00_HomePageContent_Label3" style="font-weight:bold;">* Provide correct and actual mobile number.</span><br>
                                            <span id="ctl00_HomePageContent_Label4" style="font-weight:bold;">* This mobile will remain same at the time of registration. You won’t be able to edit it. </span><br>
                                            <span id="ctl00_HomePageContent_Label5" style="font-weight:bold;">* The OTP will remain valid for 20 minutes. </span><br>
                                            <span id="ctl00_HomePageContent_Label6" style="font-weight:bold;">* You are allowed to generate OTP maximum 3 times.</span><br>
                                            <span id="ctl00_HomePageContent_Label7" style="font-weight:bold;">* After 3 consecutive attempts of generating OTP, system won’t generate any OTP for said mobile number for next 3 hours.</span><br>
                                            <span id="ctl00_HomePageContent_Label8" style="font-weight:bold;"><b>* Note:</b>
 It shall be the responsibility of the Employer to provide the correct 
Mobile Number of the Employee to prevent administrative consequences. It
 is recommended that each Insured Person should have unique mobile 
number.  </span>
                                        </td>
                                    </tr>
                                </tbody></table>
                            ...
                            <div id="ctl00_HomePageContent_panMessage" style="width: 70%; display: none; position: fixed; z-index: 100001; left: 935px; top: 450px;">
...
of appointment, for all purposes.<br>
                            ...
                            <div id="ctl00_HomePageContent_Panel3" style="width: 70%; display: none; position: fixed; z-index: 100001; left: 935px; top: 450px;">
                        ...
                        <div id="behUserDetail_backgroundElement" style="display: none; position: fixed; left: 0px; top: 0px; z-index: 10000; width: 1870px; height: 909px;" class="modalBackground"></div><div id="behUserDetail1_backgroundElement" style="display: none; position: fixed; left: 0px; top: 0px; z-index: 10000; width: 1870px; height: 909px;" class="modalBackground"></div></div>
                    <div id="ctl00_HomePageContent_UpdateProgress1" style="display:none;">
					
                            <iframe frameborder="0" src="../../public/assets/esi/woesicard1/a.html" style="border: 0px; position: absolute;
                            ...
                            <div style="position: absolute; z-index: 10; left: expression((this.offsetParent.clientWidth/2)-(this.clientWidth/2)+this.offsetParent.scrollLeft);
                                ...
                                Please Wait...<br>
                                <img src="../../public/assets/esi/woesicard1/PleaseWait.gif">
                            </div>
    ...
    <input type="hidden" name="ctl00$HomePageContent$hdncurrentdate" id="ctl00_HomePageContent_hdncurrentdate" value="18/06/2024">
	...
	<tbody><tr class="dBlockFooter" style="background-color:White;">
		<td class="dBlockFooter" colspan="5">
                    ...
                    in 1024 x 768 pixels, Designed and Developed by Wipro LTD.<span id="ctl00_lblIP" style="color:White;">IP Address : 44.</span><span id="ctl00_Label1" style="color:#742902;">ASP Session ID : yewsn45514xea5io3btcfxjd</span><span id="ctl00_Label2"></span></td>
	</tr>
</tbody></table>
    </div>
    <input type="hidden" name="ctl00$hdnhmedate" id="ctl00_hdnhmedate" value="2024 6 18">
...
<span style="display: none !important;"><input type="hidden" name="__LASTFOCUS" id="__LASTFOCUS" value=""></span><span style="display: none !important;"><input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value=""></span><span style="display: none !important;"><input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value=""></span><span style="display: none !important;"><input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value=""></span><span style="display: none !important;"><input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWFALR5JbxDgLz27n+AwLlj5PNDAL6j5PNDAL14LkjArDoruwKAqX755IOAs/n/oELArjz5doFAuKal4gJAsyd7fMNApaB9p8GArG9oZwHArL3gesGAtTens8IAszHqKcBApzUytwBAoLjnPUNApy9h6AMApvCsp8F"></span><span style="display: none !important;"><input type="hidden" name="__AjaxControlToolkitCalendarCssLoaded" id="__AjaxControlToolkitCalendarCssLoaded" value=""></span></form>
