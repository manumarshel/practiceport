...
<head>
    ...
    <title>Admin Sign In | PracticePot Simulation</title>
...
<body>
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-5 col-md-8 mb-4 mb-lg-0">
                <div class="auth-card">
                    ...
                    <h3 class="font-weight-bold text-dark mb-1" style="font-size: 22px; letter-spacing: -0.3px;">Sign In to Admin</h3>
                    <p class="text-muted mb-4" style="font-size: 13.5px;">Enter your administrator credentials to access the console.</p>
                    ...
                    <form action="<?= base_url('admin') ?>" method="post">
                        ...
                        <div class="form-group mb-3">
                            <label class="font-weight-semibold text-dark small mb-1" for="email">Admin Email Address</label>
                            <div class="input-icon-wrap">
                                <i class="bi bi-envelope prefix-icon"></i>
                                <input type="email" class="form-control" id="email" name="email" placeholder="admin@practicepot.com" value="<?= set_value('email') ?>" required autofocus>
                            </div>
                        </div>
            ...
            <div class="col-lg-6 offset-lg-1 d-none d-lg-block">
                <div class="p-4">
                    <h2 class="font-weight-bold text-dark mb-3" style="font-size: 28px; line-height: 1.3;">
                        Manage Simulations, Students & <span style="color: #2563eb;">Assessments</span>
                    </h2>
                    <p class="text-muted mb-4" style="font-size: 14.5px; line-height: 1.6;">
                        PracticePot administrative engine empowers educators and institutions to manage real-world enterprise tax simulation courses, student progress, and grading.
                    </p>
                    ...
                    <div class="feature-bullet">
                        ...
                        <div>
                            <span class="font-weight-bold text-dark d-block">Simulated Tax & Accounting Portals</span>
                            <small class="text-muted">GST, TDS, UAE VAT, ESIC & PF interactive practice</small>
                        </div>
                    </div>
                    ...
                    <div class="feature-bullet">
                        ...
                        <div>
                            <span class="font-weight-bold text-dark d-block">Comprehensive Assessments Engine</span>
                            <small class="text-muted">Automated submission review and grading management</small>
                        </div>
                    </div>
                    ...
                    <div class="feature-bullet">
                        ...
                        <div>
                            <span class="font-weight-bold text-dark d-block">Institution & Student Analytics</span>
                            <small class="text-muted">Real-time progress reporting and CSV data exports</small>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="footer-auth d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <div>
            <span class="text-muted">Secured Administrator Portal</span>
        </div>
    </footer>
