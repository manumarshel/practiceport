        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5>Amended Credit / Debit Notes (Unregistered)</h5>
                    <div>
                        <a href="<?= base_url('admin/gstr1/cdnur-amendment/add/' . $question_id) ?>" class="btn btn-primary btn-sm">
                            Add New
                        </a>
                    ...
                    if (empty($data_list)) {
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered">
                                <thead>
                                    <tr>
                                        <th>Original C/D Note No</th>
                                        <th>Revised C/D Note No</th>
                                        <th>Revised C/D Note Date</th>
                                        <th>Note Type</th>
                                        <th>Supply Type</th>
                                        <th>Actions</th>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    foreach ($data_list as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $value->revised_invoice_number; ?></td>
                                            <td><?= display_date($value->revised_invoice_date); ?></td>
                                            <td><?= $value->note_type; ?></td>

                                            <td><?= $value->supply_type; ?></td>
                                            <td>
                                                <a class="btn btn-icon btn-primary btn-tone" href="<?= base_url() . '/admin/gstr1/cdnur-amendment/add/' . $value->question_id . '/' . $v['9c_cdnur_id']; ?>">
                                                    <i class="anticon anticon-edit"></i>
                                                </a>
                                                <button class="btn btn-icon btn-danger btn-tone common_remove" data-question_id="<?= $value->question_id; ?>" data-pk_id="<?= $v['9c_cdnur_id']; ?>">
                        ...
                        <div class="modal fade" id="delete_item">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="<?= base_url() . '/admin/gstr1/cdnur-amendment/remove' ?>" method="post">
