...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url(); ?>/public/assets/simulation/css/staticapp1.2.css"
          title="app-css"/>
...
<header class="main-header">
    <div class="skip">
        <div class="container">
            <div class="row">
                <div class="col-xs-6">
                    <p class="text-left" style="margin:14px 0">This simulator is intended for educational purpose only</p>
                </div>
                <div class="col-xs-6">
    ...
    <div class="container">
        <div class="row branding">
            <div class="col-xs-12">
                <a href="javascript:void(0)" title="Goods and Services Tax Home" id="emblemDis" class="menuList"
                   data-toggle="tooltip" data-placement="top"">
                <img src="//static.gst.gov.in/uiassets/images/Emblem_of_India-white.svg" class="logo"
                     alt="Goods and Services Tax Home" width="35px" height="56px"
                     src="//static.gst.gov.in/uiassets/images/Emblem_of_India-white.svg">
                </a>
                <h1 class="site-title"><a href="javascript:void(0)" id="emblemTitDis" class="menuList"
                                          data-toggle="tooltip" data-placement="top" data-original-title="" title="">Goods
                        and Services Tax</a></h1>
                <ul class="list-inline mlinks">
                    <li>
                        <a target="_blank" href="<?=base_url('user/dashboard'); ?>" style="background: #2c4e86; padding: 10px;">Go to user dashboard</a>
                    </li>
                    <li>
                        <a href="<?=base_url('simulation/logout'); ?>" style="background: #2c4e86; padding: 10px;">Logout</a>
                    </li>
                </ul>
    ...
    <div class="container">
        <div id="main" class="navbar-collapse collapse">
            <ul class="nav navbar-nav" link="">
                ...
                <li class="has-sub drpdwn menuList"><a href="javascript:void(0)">Downloads <span
                                class="caret"></span></a></li>
                <li class="has-sub drpdwn menuList"><a href="javascript:void(0)">Search Taxpayer <span
                                class="caret"></span></a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 no-mobile">
                        ...
                        <ul>
                            <li><a href="javascript:void(0)">Central Board of Indirect Taxes and Customs <i
                                            class="fa fa-external-link-square"></i></a></li>
                            <li><a href="javascript:void(0)">State Tax Websites <i
                                            class="fa fa-external-link-square"></i></a></li>
                            <li><a href="javascript:void(0)">National Portal <i class="fa fa-external-link-square"></i></a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 no-mobile">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:void(0)">GST Media <i class="fa fa-external-link-square"></i></a>
                            </li>
                            <li><a href="javascript:void(0)">Site Map</a></li>
                            <li><a href="javascript:void(0)">Grievance Nodal Officers</a></li>
                            <li><a href="javascript:void(0)">Free Accounting and Billing Services <i
                                            class="fa fa-external-link-square"></i></a></li>
                            <li><a href="javascript:void(0)">GST Suvidha Providers <i
                                            class="fa fa-external-link-square"></i></a></li>
                        </ul>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 no-mobile">
                        ...
                        <ul>
                            ...
                            <li>
                                <span class="contact">Log/Track Your Issue:<br></span><a data-popup="true"
                                                                                         href="https://selfservice.gstsystem.in/"
                                                                                         title="Grievance Redressal Portal for GST"
                                                                                         target="_blank"
                                                                                         rel="noopener noreferrer">Grievance
                                    Redressal Portal for GST <i class="fa fa-external-link-square"></i></a>
                            </li>
                            <li class="social">
                                <a data-popup="true"
                                   href="//www.facebook.com/Goods-and-Services-Tax-1674179706229522/?fref=ts"
                                   title="Facebook"><i class="fa fa-facebook-square"></i>.</a>
                                <a data-popup="true" href="//www.youtube.com/channel/UCFYpOk92qurlO5t-Z_y-bOQ"
                                   title="Youtube"><i class="fa fa-youtube-play"></i>.</a>
                                <a data-popup="true" href="//twitter.com/Infosys_GSTN"><i class="fa fa-twitter"
                                                                                          title="Twitter"></i>.</a>
                                <a data-popup="true"
                                   href="//www.linkedin.com/company/gstn-official/about/?viewAsMember=true"
...
<script>
    const baseUrl = '<?php echo base_url(); ?>' + '/simulation';
</script>
<script src="<?=base_url(); ?>/public/assets/simulation/js/simulation.js?version=<?=time(); ?>"></script>
