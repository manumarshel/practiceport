...
//    $routes->match(['post'], 'delete-ad/(:num)', 'Admin/Ads::delete', ['filter' => 'auth']);
    ...
    $routes->add('b2b_packages', 'Admin/B2b::index', ['filter' => 'auth']);
    $routes->match(['get', 'post'], 'add', 'Admin/B2b::add', ['filter' => 'auth']);
...
$routes->match( ['get','post'],'delete/(:num)','Admin/Institution::delete/$1', ['filter' => 'auth']); 
    ...
    $routes->get('video-tutorials/get-course-items/(:num)', 'Admin\VideoTutorials::getCourseItems/$1', ['filter' => 'auth']);
