        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5>Exports - Add Details</h5>
                </div>
                <div class="m-t-30">
                    <form id="form_validation" action="<?= base_url() . '/admin/gstr1/export/add/' . $question_id; ?>" method="post" class="form">
                        <input type="hidden" name="question_id" value="<?= $question_id; ?>" /> 
                        <input type="hidden" name="pk_id" value="<?= $pk_id; ?>" />
                        <div class="row">
                            <div class="col form-group">
                                <label for="">Invoice no. </label>
                                <input name="invoice_number" value="<?= set_value('invoice_no', ((!empty($form_data['invoice_no'])) ? $form_data['invoice_no'] : '')); ?>" type="text" class="form-control" placeholder="">
                            </div>
                            <div class="col form-group">
                        ...
                        <div class="row">
                            <div class="col form-group">
                                ...
                                <input name="billing_no" value="<?= set_value('billing_no', ((!empty($form_data['billing_no'])) ? $form_data['billing_no'] : '')); ?>" type="text" class="form-control" placeholder="">
                            </div>
                            <div class="col form-group">
                                <label for="">Shipping Bill Date/Bill of Export Date</label>
                                <input name="shipping_date" value="<?= set_value('shipping_date', ((!empty($form_data['shipping_date'])) ? $form_data['shipping_date'] : '')); ?>" type="text" class="form-control datepicker" autocomplete="off" placeholder="">
                            </div>
                            <div class="col form-group">
