                ...
                <div class="m-t-30">
                    <div class="row">
                        ...
                        if (isset($company_) && !empty($company_)):
                            ...
                            $esiCode =  $company_['esi_code'] ?? '';
                            $establishment_id =$company_['establishment_id'] ?? '';
                             $lin_id =$company_['lin_id'] ?? '';
                        
                        endif;
                        ?>
                        <div class="col-md-12">
                            <?php if (isset($company_) && !empty($company_)): ?>
                            <form action="<?= base_url(); ?>/user/save_accounting ?>" method="post" class="form">
                                <?php else: ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col form-group">
                                        ...
                                        <input name="esi_code" type="text" class="form-control" placeholder="" value="<?= $esiCode; ?>">
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col form-group">
                                        <label for="">LIN ID:</label>
                                        <input name="lin_id" type="text" class="form-control" placeholder="" value="<?= $lin_id; ?>">
                                    </div>
                                    <div class="col form-group">
                                        <label for="">Establishment Id:</label>
                                        <input name="establishment_id" type="text" class="form-control" placeholder="" value="<?= $establishment_id; ?>">
                                    </div>
                                </div>
