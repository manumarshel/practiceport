        ...
        <div class="mypage">
                    ...
                    <div data-breadcrumb="" data-path="//www.gst.gov.in/" data-name="Home">
                        <ol class="breadcrumb" data-ng-controller="crumbCtrl">
                            ...
                            <li data-ng-repeat="breadcrumb in breadcrumbs.getAll()">
                                <ng-switch on="$last"><span ng-switch-when="true"> B2BA</span></ng-switch>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="row invsumm">
                <div class="col-xs-12 col-sm-12 taxp">
                    <h4>Amended B2B Invoices - Summary</h4>
            ...
            <div class="tabpane">
                ...
                <div class="tbl-format rettbl-format">
                    <form name="b2bAmendSearch" class="ng-pristine ng-invalid ng-invalid-required ng-valid-pattern ng-valid-maxlength others" method="get" action="b2b-amendment-add"  autocomplete="off" novalidate="">
                        <div class="row mar-b">
