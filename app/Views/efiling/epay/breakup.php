...
<br>
    ...
    <input  type="radio" id="radio" class="extraMarginTop" checked="true" name="type" value="1">
    <label class="radioLabel" for="radio">Other than Company Deductee – Income Tax (Other than Companies) (0021)</label>

    <br>

    <input  type="radio" id="radioTwo" class="extraMarginTop" name="type" value="2">
    <label class="radioLabel" for="radio">Company Deductee – Corporation Tax (0020)</label>

    <div class="formContainer">
      <form id="form_breakup" name="" action="/e-filing/new-epaytax-submit" method="post">
        <input type="hidden" name="status" id="status" value="0" />
        <div>
          <label>(a) Tax</label>
          <input type="number" class="input-number" name="tax"  placeholder="Rs 0" />
        </div>
        <div>
          <label>(b) Surcharge</label>
          <input type="number" class="input-number" name="supercharge" placeholder="Rs 0"/>
        </div>
        <div>
          <label>(c) Cess</label>
          <input type="number" class="input-number" name="cess" placeholder="Rs 0"/>
        </div>
        <div>
          <label>(d) Interest</label>
          <input type="number" class="input-number" name="interest" placeholder="Rs 0"/>
        </div>
        <div>
          <label>(e) Penalty</label>
          <input type="number" class="input-number" name="penalty" placeholder="Rs 0"/>
        </div>
        <div>
          <label>(f) Fee Under Section 234E</label>
          <input type="number" class="input-number" name="fees" placeholder="Rs 0"/>
        </div>
      ...
      <div class="formFooter">
        <p>In Words</p>
        <p id="wordsTotal">Zero Rupees</p>
      </div>
    </div>

    <button class="backButton" style="cursor:pointer;"><a href="/e-filing/new-epaytax-nature">< Back</a></button>
