...
function calltextboxdata(Xmldocparamval, ivalue, controlidvaldata) {
    if (document.getElementById(controlidvaldata)) {
        if (document.getElementById(controlidvaldata).value != "") {
            var stringreturn = '<' + Xmldocparamval.getElementsByTagName("FeatureName")[ivalue].childNodes[0].nodeValue + '>'
         + document.getElementById(controlidvaldata).value.replace(/ /g, '') + //merged half(i.,e .replace(/ /g, '')
         '</' + Xmldocparamval.getElementsByTagName("FeatureName")[ivalue].childNodes[0].nodeValue + '>\n';
        }
        else {
            var stringreturn = '<' + Xmldocparamval.getElementsByTagName("FeatureName")[ivalue].childNodes[0].nodeValue + '>'
...
function callradiobuttonlistdatatext(xmlDocval, ivalue, controlidval) {
    ...
    if (RB1 != null) {
        ...
        var selectedtext = "";
        var i = 0;
       // alert(radio.length); //merged(commented)
        for (var i = 0; i < radio.length; i++) {
            ...
            if (radio[i].checked) {
                ...
                //alert("SelectedValue = " + radio[i].value);//merged(commented)
...
function websignerPopUpNI(data) {
    ...
    try {
        ...
        document.getElementById('ctl00_HomePageContent_hdnXmlChild').value = data;
        var tbs = data;
        //var signform = document.frmsubmitDSC;
        ...
        if (tbs != '') {
            ...
            websignerapplet = document.websignerapplet;
            websignerapplet.open(tbs, "sign", "", "", "emasSubmitclaim()", "emasCancel()");
...
function emasSubmitMenu() {
 ...
 document.getElementById("ctl00_HomePageContent_HashDataValue").value = signData;
   // document.getElementById('ctl00_HomePageContent_DigitalSignatureComp1_CheckBox1').checked = false;
    ...
    if (document.getElementById('ctl00_HomePageContent_submit') != undefined) {
        alert("hi save");
        var buttonid = document.getElementById('ctl00_HomePageContent_submit').id;
        alert(buttonid);
        Checksubmitdata(buttonid);
    }
    else if (document.getElementById('ctl00_HomePageContent_send') != undefined) {
    alert("hi send");
    var buttonid = document.getElementById('ctl00_HomePageContent_send').id;
    alert(buttonid);
    Checksubmitdata(buttonid);
    }   
...
function websignerPopUpMenu(data) {
    ...
    try {
        ...
        alert(data);
        alert(document.getElementById('ctl00_HomePageContent_OrginalXMLContent'));
        document.getElementById('ctl00_HomePageContent_OrginalXMLContent').value = data;
        var tbs = data;
        //var signform = document.frmsubmitDSC;
        ...
        if (tbs != '') {
            ...
            websignerapplet = document.websignerapplet;
            //websignerapplet.open(tbs, "sign", "", "", "emasSubmitMenu()", "emasCancel()");
