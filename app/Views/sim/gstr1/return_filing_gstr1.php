    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 text-right breadcrumb">
                <a href="<?php echo $slot23; ?>" class="v-help" target="_blank"><i class="fa fa-info-circle"></i> Help</a>
            </div>
        </div>
        ...
        <?php if (!isset($_GET['return-status'])) { ?>
            <div class="row invsumm">
                <div class="col-xs-12 col-sm-12 taxp">
                    <h4 class="pull-left">Returns Filings for GST GSTR-1</h4>
                    <h4>
                        <button class="btn btn-primary btn-circle btn-sm pull-right" data-toggle="tooltip"
                                title="Refresh" data-ng-click="refresh()" data-ng-disabled="refbtn"
                                style="margin-top: 0px;">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="verify_otp">VERIFY</button>
