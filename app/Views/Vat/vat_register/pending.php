<html lang="en"><head>
        ...
        <script nonce="" type="text/javascript">
            var logoutUrl = "/vat/restoreSession/logout?_HDIV_STATE_=12-1-17D33EE66731EC80724A8F35ECF87D3E";
            var validateSessionUrl = "/vat/restoreSession/validateActivity?_HDIV_STATE_=12-2-17D33EE66731EC80724A8F35ECF87D3E";
            var logoutFuncUrl = "/vat/logout?_HDIV_STATE_=12-0-17D33EE66731EC80724A8F35ECF87D3E";
        </script>
        <style>
            .error {
            color: red;
                ...
                <div class="col-md-4" style="float: right;text-align:right;font-size: 11px;margin-right: 10px;">
                    ...
                    <div>
                       ...
                       <span style="color:#FFF;padding:3px 3px;margin-top:5px;">
                           <a href="/vat/logout"><i class="fa fa-sign-out fa-2"></i> Logout</a>
                       </span>
