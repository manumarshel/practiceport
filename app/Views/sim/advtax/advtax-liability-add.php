        ...
        <div class="mypage">
            ...
            <div class="row invsumm">
                <div class="col-xs-12 col-sm-8 ">
                    <h4>Tax Liability (Advance Received) - Add Details</h4>
                </div>
            ...
            <div class="tabpane">
                ...
                <div class="tbl-format rettbl-format">
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <br>
                            <input type="checkbox" class="chkbx ng-pristine ng-untouched ng-valid ng-empty" id="eligible_to_taxed" name="eligible_to_taxed">
                        ...
                        <div class="col-sm-3" data-ng-if="rate_flag=='Y'">
                            ...
                            <select class="form-control ng-pristine ng-untouched ng-valid ng-not-empty ng-valid-required" name="rate_prcnt" id="rate_prcnt" data-ng-model="rate_prcnt" required="" data-ng-disabled="b2bnewview">
                                <option selected="65" value="65">65%</option>
                            </select>
                        </div>
                    </div>
                </div>
