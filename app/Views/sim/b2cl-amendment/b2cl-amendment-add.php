        ...
        <div class="mypage">
            ...
            <div class="tabpane">
                <form id="b2cl_amend_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" name="original_invoice_number"
                                   class="form-control"
                                   id="original_invoice_number" value="<?php echo $invoice_details->original_invoice_number; ?>" disabled="">
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <label class="reg m-cir" for="revised_invoice_no">Revised Invoice No</label>
                            <input type="text" name="revised_invoice_no"
                                   class="form-control"
                                   id="revised_invoice_no" value="" >
                        </div>
                        <div class="col-sm-4">
                            <label class="reg m-cir" for="revised_invoice_date">Revised Invoice Date</label>
