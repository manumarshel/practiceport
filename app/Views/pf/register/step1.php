...
<form id="memRegDetails" name="memRegDetails" role="form" class="form-horizontal" action="/epfo/uanmember/saveMemberDetails" method="post">
...
<div class="form-group" id='memreg1'>
    ...
    <div id='individualReg'>
        <h6 class="panel-title pull-right" >
            <a href="/epfo/memberRegSearch/individualRegistrationSearch?_HDIV_STATE_=13-70-31C45EF7EE5944E342807A0AF2F8BF2C" class='approveMember'>View All&nbsp;&nbsp;</a>
        </h6>
    </div>
