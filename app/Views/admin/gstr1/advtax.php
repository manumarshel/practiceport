        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5>Tax Liability (Advance Received)</h5>
                    <div>
                        <a href="<?= base_url('admin/gstr1/adv-tax/add/'.$question_id) ?>" class="btn btn-primary btn-sm">
                            Add New
                        </a>
                                ...
                                <tbody>
                                    ...
                                    foreach ($data_list as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-icon btn-primary btn-tone" href="<?= base_url() . '/admin/gstr1/adv-tax/add/' . $value->question_id . '/' . $v['11a_tax_id']; ?>">
                                                    <i class="anticon anticon-edit"></i>
                                                </a>
                                                <button class="btn btn-icon btn-danger btn-tone common_remove" data-question_id="<?= $value->question_id; ?>" data-pk_id="<?= $v['11a_tax_id']; ?>">
                        ...
                        <div class="modal fade" id="delete_item">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="<?= base_url() . '/admin/gstr1/adv-tax/remove' ?>" method="post">
