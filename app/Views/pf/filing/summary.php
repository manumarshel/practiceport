            ...
            <div class="form-group">
                                ...
                                <table class="table table-striped table-condensed table-bordered">
                                    ...
                                    <tr>
                                        <th>Gross Wages (<i class="fa fa-rupee">)</td>
                                            <td class="algnright">       3,10,738</td>
                                    </tr> 
                                    <tr>
                                    ...
                                    <tr>
                                        <th>EDLI Wages (<i class="fa fa-rupee">)</td>
                                                <td sclass="algnright">       3,10,738</td>
                                    </tr>
                                    <tr>
                                        <th>NCP Days</td>
                            ...
                            <td class="tds">
                                <table class="table table-striped table-condensed table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="algnright">         37,289</td>
                                    </tr> 
                                    <tr>
                                        <th>EPF ER Share</td>
                                        <td class="algnright">31</td>
                                        <td class="algnright">         11,406</td>
                                    </tr> 
                                    <tr>
                                        <th>EPS Contribution</td>
                                        <td class="algnright">31</td>
                                        <td class="algnright">         25,886</td>
                                    </tr>
                                    <tr>
                                        <th>EDLI Contribution</td>
                                        <td class="algnright">31</td>
                                        <td class="algnright">1552</td>
                                    </tr>                                                    
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="algnright"></td>
                                        <td class="algnright"><label id="totalRemitted">         76,133</label></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table class="table table-striped table-condensed table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td  class=" vertmidright" >         37,289</td>                            
                                <td  class=" vertmidcenter" >-</td>
                                
                                <td  class=" vertmidright">              0</td>
                                <td  class=" vertmidright" >37289</td>
                            </tr>
                            <tr>
                                <th class=" vertmidleft" colspan="2">Total EPS Contribution (A/C 10)</th>                            
                                <td class=" vertmidright">         25,886</td>                            
                                <td class=" vertmidright">              0</td>
                                
                                <td class=" vertmidright">              0</td>
                                <td class=" vertmidright" >25886</td>
                            </tr>
                            <tr>
                                <th class=" vertmidleft" colspan="2" >Total Difference Between EPF & EPS (ER Share A/C 1)</th>                            
                                <td class=" vertmidright">         11,406</td>                                                        
                                <td class=" vertmidright">              0</td>  
                                
                                <td class=" vertmidright">              0</td>
                                <td class=" vertmidright">11406</td>                            
                            </tr>

                            <tr>
                                <th class=" vertmidleft" colspan="2">Total EDLI Contribution (ER Share A/C 21)  <label class="lbl">*</label></th>                            
                                <td class=" vertmidright"><input id="edliContributionRemitted" name="edliContributionRemitted" onkeypress="return isNumber(event);" type="text" class="form-control inpt" init-value="1552" onblur="getTotalRemitted();" value="1552"/></td>                            
                                <td class=" vertmidcenter">-</td>
                                <td class="vertmidcenter">-</td>
                                    <td class=" vertmidright" ><label id="netEdliNetpayable">1552</label></td>                            
                            </tr>
                            <tr>
                                ...
                                <th class=" vertmidleft">Administration  <label class="lbl">*</label>
                                        ...
                                        <td class=" vertmidright">1554</td>
                                        <input id="epfAdministrationCharges" name="epfAdministrationCharges" type="hidden" value="1554"/>
                                    
                                    
                                    <td class=" vertmidcenter">-</td>
                                    <td class=" vertmidcenter">-</td>
                                    <td class=" vertmidright"><label id="netEpfAdministrationCharges">1554</label></td>                            
                            </tr>
                            ...
                            <tr class="bg-success"> 
                                ...
                                <th class=" vertmidright"><span id="totalAmountECR">77687</span>
                                    <input id="totaleECRRemittedAmount" name="totaleECRRemittedAmount" type="hidden" value="77687"/>
                                </th>                            
                                <th class=" vertmidright">0</th>
                                    
                                <th class=" vertmidright">0</th>
                                <th  class=" vertmidright"><span id="totalNetPayableAmountSpan">77687</span>
                                    <input id="totalNetPayableAmount" name="totalNetPayableAmount" type="hidden" value="77687"/>
                                </th>
                            </tr>
                        <tbody>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-7">
                        ...
                        <a class="btn btn-default"  href="/epfo/ecr/init?_HDIV_STATE_=8-68-25CDB7ED346161625AD757B8F666CA7A" title="Click to go to ECR upload page.">
                            Cancel
                        </a>
                    </div>
                </div>
