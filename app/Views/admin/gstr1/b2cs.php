        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5>B2C (Others)</h5>
                    <div>
                        <a href="<?= base_url('admin/gstr1/b2cs/add/' . $question_id) ?>" class="btn btn-primary btn-sm">
                            Add New
                        </a>
                                ...
                                <tbody>
                                    ...
                                    foreach ($data_list as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-icon btn-primary btn-tone" href="<?= base_url() . '/admin/gstr1/b2cs/add/' . $value->question_id . '/' . $v['b2c_others_id']; ?>">
                        ...
                        <div class="modal fade" id="delete_item">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="<?= base_url() . '/admin/gstr1/b2cs/remove' ?>" method="post">
