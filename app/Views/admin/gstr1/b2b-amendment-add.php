        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5>Amended B2B Invoices - Add Invoice</h5>
                </div>
                <div class="m-t-30">
                 <form id="form_validation" action="<?= base_url() . '/admin/gstr1/'.$path.'/' . $question_id; ?>" method="post"  class="form">
                     ...
                     <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col form-group">
                                <label for="">Original Invoice Number</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col form-group">
                                ...
                                <input type="text" name="total_invoice_value" value="<?= set_value('total_invoice_value', ((!empty($form_data['total_invoice_value'])) ? $form_data['total_invoice_value'] : '')); ?>" class="form-control" placeholder="">
                            </div>
                            <div class="col form-group">
