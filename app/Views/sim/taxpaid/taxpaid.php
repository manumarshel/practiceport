        ...
        <div class="mypage">
                    ...
                    <div data-breadcrumb="" data-path="//www.gst.gov.in/" data-name="Home">
                        <ol class="breadcrumb" data-ng-controller="crumbCtrl">
                            ...
                            <li data-ng-repeat="breadcrumb in breadcrumbs.getAll()">
                                <ng-switch on="$last"><span ng-switch-when="true"> Adjustment of Advances</span></ng-switch>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="row invsumm">
                <div class="col-xs-12 col-sm-12 taxp">
                    <h4>Adjustment of Advances - Summary</h4>
...
<!--                        <th>Total invoce value</th>-->
            ...
            <div class="btn-toolbar">
                <a href="taxpaid-add" class="btn btn-primary pull-right">Add State wise Details</a>
