        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5>Amended Tax Liability (Advance Received) - Add Details</h5>
                </div>
                <div class="m-t-30">
                    <form id="form_validation" action="<?= base_url() . '/admin/gstr1/adv-tax-amendment/add/' . $question_id; ?>" method="post"  class="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col form-group">
                                <label for="">Financial Period</label>
