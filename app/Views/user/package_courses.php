...
<div class="sim-table-wrapper mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0 fw-bold">Modules </h4>
    </div>
    ...
    <div class="d-flex flex-column gap-3">
        <?php if (!empty($courses)): 
            ...
            foreach ($courses as $course):
                ...
                $runLink = base_url('user/course-lessons/' . $cId . '/' . $package_id);
        ?>
                    ...
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                       ...
                       <!--  <div class="course-icon-wrap rounded-circle d-flex align-items-center justify-content-center" 
                        ...
                        <div class="flex-grow-1 pe-4">
                            <h5 class="fw-bold mb-1" style="font-size: 17px; text-transform: uppercase;"><?= htmlspecialchars($course['course_name']) ?></h5>
        ...
        <?php endforeach; else: ?>
            ...
            <div class="text-center p-5 bg-white border rounded-3 shadow-sm">
                ...
                <p class="text-muted">No courses are available under this package.</p>
                <a href="<?= base_url('user/dashboard'); ?>" class="btn filter-btn mt-2">Back to Dashboard</a>
            </div>
        <?php endif; ?>
    </div>
</div>
