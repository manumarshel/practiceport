...
class TaxpaidAmendment extends \App\Controllers\BaseController
{
    public function index() {
        ...
        return view('sim/taxpaid-amendment/taxpaid-amendment', $data);
    }

    public function taxpaid_amendment_add() {
        helper(['form', 'common']);
