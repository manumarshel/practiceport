                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <?php foreach ($current_details as $detail): ?>
                            <tr>
                                ...
                                <td><?php echo $detail['port_code']; ?></td>
                                <td><?php echo $detail['gst_payment']; ?></td>
                                <td><?php echo $detail['billing_no']; ?></td>
<!--                                <td>--><?php //echo $detail['shipping_date']; ?><!--</td>-->
                            </tr>
                ...
                <div class="btn-toolbar">
                    <a href="<?php echo 'export-add'; ?>" class="btn btn-primary pull-right">Add Details</a>
