        ...
        <div class="mypage">
                    ...
                    <div data-breadcrumb="" data-path="//www.gst.gov.in/" data-name="Home">
                        <ol class="breadcrumb" data-ng-controller="crumbCtrl">
                            ...
                            <li data-ng-repeat="breadcrumb in breadcrumbs.getAll()">
                                <ng-switch on="$last"><span ng-switch-when="true"> B2CLA</span></ng-switch>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="row invsumm">
                <div class="col-xs-12 col-sm-12 taxp">
                    <h4>Amended B2C(Large) Invoices- Summary</h4>
            ...
            <div class="tabpane">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        foreach ($current_details as $detail): ?>
                            <tr>
                                ...
                                <td><?php echo $detail['revised_invoice_no']; ?></td>
                                <td><?php echo $detail['revised_invoice_date']; ?></td>
                ...
                <div class="tbl-format rettbl-format">
                    <form name="amendSearch" class="ng-pristine ng-invalid ng-invalid-required ng-valid-pattern ng-valid-maxlength others" method="get" action="b2cl-amendment-add" autocomplete="off" novalidate="">
                        <div class="row mar-b">
                            ...
                            -->
                            <div class="col-sm-4">
                                <label class="reg m-cir" for="invoice_number" >Invoice no.</label>
