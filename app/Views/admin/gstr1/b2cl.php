        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5>B2C(Large) Invoices</h5>
                    <div>
                        <a href="<?= base_url('admin/gstr1/b2cl/add-invoice/' . $question_id) ?>" class="btn btn-primary btn-sm">
                            Add New
                        </a>
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data_list as $value) {
                                        ?>
                                        <tr>
                                            <td><a href="javascript:void(0);"><?= $value->invoice_no; ?></a></td>
                                            <td><?= display_date($value->invoice_date); ?></td>
                                            <td><?= $value->total_invoice_value; ?></td>
                                            <td><?= $value->pos; ?></td>
                                            <td><?= $value->supply_type; ?></td>
                                            <td>
                                                <a class="btn btn-icon btn-primary btn-tone" href="<?= base_url() . '/admin/gstr1/b2cl/add-invoice/' . $value->question_id . '/' . $value->b2c_id; ?>">
                                                    <i class="anticon anticon-edit"></i>
                                                </a>
                                                <button class="btn btn-icon btn-danger btn-tone common_remove" data-question_id="<?= $value->question_id; ?>" data-pk_id="<?= $value->b2c_id; ?>">
                        ...
                        <div class="modal fade" id="delete_item">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="<?= base_url() . '/admin/gstr1/b2cl/remove' ?>" method="post">
