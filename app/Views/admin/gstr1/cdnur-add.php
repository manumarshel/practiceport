        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5>Credit / Debit Notes (Unregistered) - Add Note</h5>
                </div>
                <div class="m-t-30">
                    <form id="form_validation" action="<?= base_url() . '/admin/gstr1/cdnur/add/' . $question_id; ?>" method="post"  class="form">
                        ...
                        <div class="row">
                            <div class="col form-group">
                                ...
                                <input name="invoice_number" value="<?= set_value('invoice_number', ((!empty($form_data['dc_note_no'])) ? $form_data['dc_note_no'] : '')); ?>" type="text" class="form-control" placeholder="">
                            </div>
                            <div class="col form-group">
                                <label for="">Debit/Credit Note Date</label>
                                <input name="invoice_date" value="<?= set_value('invoice_date', ((!empty($form_data['dc_note_date'])) ? display_date($form_data['dc_note_date']) : '')); ?>" type="text" class="form-control datepicker" autocomplete="off" placeholder="">
                            </div>
                            <div class="col form-group">
                                <label for="">Note Type</label>
                                <select name="note_type" class="form-control" id="note_type">
                                    <option value="" <?= ((empty($form_data)) ?  'selected' : '') ; ?>>Select</option>
                                    <option value="Credit Note" <?= set_value('note_type', ((!empty($form_data)) ? (($form_data['note_type'] == 'Credit Note') ? 'selected' : '') : '')); ?>>Credit note</option>
                                    <option value="Debit Note" <?= set_value('note_type', ((!empty($form_data)) ? (($form_data['note_type'] == 'Debit Note') ? 'selected' : '') : '')); ?>>Debit note</option>
                                </select>
