...
<meta http-equiv="content-type" content="text/html; charset=UTF-8"><title>EmployeeRegistration</title><link rel="stylesheet" type="text/css" href="../../public/assets/esi/woesicard/esicCSSglobal.css"><link rel="stylesheet" type="text/css" href="../../public/assets/esi/woesicard/esiccsstaskhome.css"><link rel="stylesheet" type="text/css" href="../../public/assets/esi/woesicard/esiclayout.css">




    <script type="text/javascript" src="../../public/assets/esi/woesicard/JavaScript1.js"></script>
    ...
    <link href="../../public/assets/esi/woesicard/WebResource.css" type="text/css" rel="stylesheet"><link type="text/css" rel="stylesheet" href="../../public/assets/esi/woesicard/WebResource.css"></head>
...
<script src="../../public/assets/esi/woesicard/WebResource_002.js" type="text/javascript"></script>


<script src="../../public/assets/esi/woesicard/ScriptResource_004.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_002.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_005.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/jquery1.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/esic.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_008.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_009.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_007.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_005.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_006.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_003.js" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_011.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_002.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_012.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_010.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_013.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_003.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/ScriptResource_004.es" type="text/javascript"></script>
<script src="../../public/assets/esi/woesicard/WebResource.js" type="text/javascript"></script>
<script type="text/javascript">
//<![CDATA[
...
//]]>
	...
	<tbody><tr>
		<td class="tHeadImage" align="left"><img id="ctl00_ESICLogo" src="../../public/assets/esi/woesicard/Small%20Logo.jpg" align="absmiddle" style="border-width:0px;"></td><td class="tHeadImage" align="center"></td><td class="tHeadImage" align="right"><img id="ctl00_Image1" src="../../public/assets/esi/woesicard/IndianSymbol.jpg" align="absmiddle" style="border-width:0px;"></td>
	</tr><tr>
                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="0" class="internalTable3">
                                    <tbody><tr>
                                        ...
                                        <td colspan="2" class="lastFormValue" width="60%">
                                            <input name="ctl00$HomePageContent$txtmobilenumber" type="text" maxlength="10" id="ctl00_HomePageContent_txtmobilenumber" class="txtbox numericAlignRight" autocomplete="Off" onkeypress="return onlyNumbers(event)">
                                            <a href="" onclick="startTimer();" id="ctl00_HomePageContent_lnkmobilecheck" >Validate Mobile Number</a>
                                            <span id="ctl00_HomePageContent_RequiredFieldValidator3" style="color:Red;"><?php echo $mobile_required ?? ''; ?></span>
                                            <span id="ctl00_HomePageContent_PresentMobileNoRegularExpressionValidator1" class="errordisplay" style="color:Red;"><?php echo $mobile_length ?? ''; ?></span>
...
number.  </span>
                            ...
                            <div id="ctl00_HomePageContent_panMessage" style="width: 70%; display: none; position: fixed; z-index: 100001; left: 935px; top: 487.5px;">
...
of appointment, for all purposes.<br>
                            ...
                            <div id="ctl00_HomePageContent_Panel3" style="width: 70%; display: none; position: fixed; z-index: 100001; left: 935px; top: 487.5px;">
                        ...
                        <div id="behUserDetail_backgroundElement" style="display: none; position: fixed; left: 0px; top: 0px; z-index: 10000; width: 1870px; height: 984px;" class="modalBackground"></div><div id="behUserDetail1_backgroundElement" style="display: none; position: fixed; left: 0px; top: 0px; z-index: 10000; width: 1870px; height: 984px;" class="modalBackground"></div></div>
                    <div id="ctl00_HomePageContent_UpdateProgress1" style="display:none;">
					
                            <iframe frameborder="0" src="../../public/assets/esi/woesicard/a.html" style="border: 0px; position: absolute;
                            ...
                            <div style="position: absolute; z-index: 10; left: expression((this.offsetParent.clientWidth/2)-(this.clientWidth/2)+this.offsetParent.scrollLeft);
                                ...
                                Please Wait...<br>
                                <img src="../../public/assets/esi/woesicard/PleaseWait.gif">
                            </div>
...
<span style="display: none !important;"><input type="hidden" name="__LASTFOCUS" id="__LASTFOCUS" value=""></span><span style="display: none !important;"><input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value=""></span><span style="display: none !important;"><input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value=""></span><span style="display: none !important;"><input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value=""></span><span style="display: none !important;"><input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWEwKjnrKzDwLz27n+AwLlj5PNDAL6j5PNDAL14LkjArDoruwKAqX755IOArjz5doFAuKal4gJAsyd7fMNApaB9p8GArG9oZwHArL3gesGAtTens8IAszHqKcBApzUytwBAoLjnPUNApy9h6AMApvCsp8F"></span><span style="display: none !important;"><input type="hidden" name="__AjaxControlToolkitCalendarCssLoaded" id="__AjaxControlToolkitCalendarCssLoaded" value=""></span></form>
...
<script type="text/javascript">
    ...
    $("#ctl00_HomePageContent_lnkmobilecheck").on('click', function(e){
        e.preventDefault();
        $("#aspnetForm").submit();
    })
</script>
