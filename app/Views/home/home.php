        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="mainNavbar">
                ...
                <div class="ms-auto d-flex align-items-center">
                    ...
                    <!-- Login -->
                    <a href="<?= base_url('demo_user') ?>" class="nav-link fw-medium me-4 login-link">
                        Login
                    </a>
    ...
    <section class="hero text-center py-5">
        <div class="container">
            ...
            <div class="mt-4 inline-btns" >
                <a href="<?= base_url('user') ?>" class="btn get-started-btn me-3">Get Started Now →</a>
    ...
    <!-- ================= SIMULATIONS ================= -->
     <section class="section-padding ">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="custom-card h-100 d-flex flex-column">
                        ...
                        <div class="card-body-custom d-flex flex-column flex-grow-1">
                            ...
                            <!-- Push link to bottom -->
                            <div class="mt-auto">
                                <a href="<?= base_url('user') ?>" class="know-more">Know More →</a>
                            </div>
                        </div>
        ...
        <div class="container py-4 text-center">
            <a href="<?= base_url('user') ?>" class="btn btn-outline-custom">View All Simulations</a>
        </div>
    </section>
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="sim-card h-100 d-flex flex-column">
                                    ...
                                    <div class="sim-body d-flex flex-column flex-grow-1">
                                        ...
                                        <div class="mt-auto">
                                            <a href="<?= base_url('user') ?>" class="btn btn-orange w-100">Start Simulation</a>
                                        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 text-white">
                    ...
                    <a href="<?= base_url('user') ?>" class="btn btn-orange px-4 py-3">
    ...
    <section class=" text-center section-padding" style="background:#fff;">
        <div class="container">
            ...
            <div class="d-flex justify-content-center gap-3 mb-5">
                <a href="<?= base_url('user') ?>" class="btn get-started-btn">Try Now</a>
                <a href="<?= base_url('user') ?>" class="btn btn-outline-custom">Get Full Access</a>
            </div>
...
"</p>
    ...
    <section class="cta-section">
        <div class="cta-card">
            ...
            <a href="<?= base_url('user') ?>" class="cta-btn">Contact Support</a>
        </div>
    </section>
