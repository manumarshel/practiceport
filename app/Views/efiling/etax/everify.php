...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../public/assets/efiling/css/TDSUploadPage.css">
...
<form id="tds_submit" name="tds_form" method="POST" action="/e-filing/verify-submit" enctype="multipart/form-data">
     <p class="note"><span class="noteBold">Note:</span> Kindly select appropriate mode of verification as prescribed iin rule 12(3) of IT rules.</p>

     <h4 class="detailHeader">How do you want to e-verify?</h4>
      <input type="hidden" name="tax_id" value="<?php echo $epaytax_id; ?>" >
     <div class="radioHolder margin1rem">
         <div class="margin1rem">
             <input type="radio" name="verify_type" id="aadhar" value="aadhar" checked/>
             <label class="detailTitle">I would like to verify using OTP on mobile number registerd with Adhaar</label>
         </div>

         <div class="margin1rem">
            <input type="radio" name="verify_type" id="dsc" value="dsc" />
             <label class="detailTitle">I would like to verify using Digital Signature Certificate(DSC)</label>
         </div>
     </div>

     <div class="radioHolder margin1rem">
         <h3 class="detailHeaderTwo">Generate electronic verification code(EVC)</h3>
         <div class="margin1rem">
             <input type="radio" name="evc_code" id="bank_account" value="bank_account" />
             <label class="detailTitle">Through Bank Account</label>
         </div>
         <div class="margin1rem">
             <input type="radio" name="evc_code" id="demat_account" value="demat_account" />
             <label class="detailTitle">Through Demat Account</label>
         </div>
     ...
     <div class=" margin1rem">
         <div class="margin1rem">
             <input type="radio" name="evc_code" id="already_have" value="already_have" />
             <label class="detailTitle">I already have an Electronic Verification Code (EVC)</label>
         </div>

         <div class="margin1rem">
             <input type="radio" name="evc_code" id="have_otp" value="have_otp"/>
             <label class="detailTitle">I already have an OTP on Mobile number registered with Aadhaar</label>
         </div>
 ...
 <div class="buttonHolder">
     ...
     <button class="continueBtn" id="succesTDS" type="submit" >Continue ></button>
 </div>
 </form>
</div>
