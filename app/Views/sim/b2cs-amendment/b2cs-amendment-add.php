                ...
                <div class="tabpane">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <select name="original_pos" class="form-control" id="pos" readonly="">
                                    <option value="" disabled="" selected="selected">Select</option>
                                    <?php
//                                    var_dump($pos_list);
                                    foreach ($pos_list as $k => $value) {
                                        echo '<option label="' . $value . '" value="' . $k . '" ' . set_value('original_pos', ((!empty($invoice_details)) ? (($invoice_details->original_pos == $k) ? 'selected' : '') : '')) . '>' . $value . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <label class="reg m-cir" for="pos"><span>Revised POS</span>
                                    <i class="fa fa-info-circle" data-placement="top" aria-hidden="true"></i></label>
                                <!--                                --><? //= view('sim/cmps/pos.php'); ?>
                                <select name="revised_pos" class="form-control" id="revised_pos" >
                                    <option value="" disabled="" selected="selected">Select</option>
                                    <?php
                                    //                                    var_dump($pos_list);
                                    foreach ($pos_list as $k => $value) {
//                                        echo '<option label="' . $value . '" value="' . $k . '" ' . set_value('revised_pos', ((!empty($invoice_details)) ? (($invoice_details->revised_pos == $k) ? 'selected' : '') : '')) . '>' . $value . '</option>';
                ...
                <input type="hidden" name="focus_key" value="original_pos">
